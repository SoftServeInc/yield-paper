...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--metric', type=str, default=None,
                        choices=['auc', 'prc-auc', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy', 'f1_score'],
...
def modify_train_args(args: Namespace):
    ...
    if not ((args.dataset_type == 'classification' and args.metric in ['auc', 'prc-auc', 'accuracy', 'f1_score']) or
