...
def compute_embeddings(model: nn.Module,
    ...
    """
    Computes the molecule/reaction vectors output from the last layer of
    a MoleculeModel/ReactionModel.
    ...
    reaction = isinstance(data, ReactionDataset)

    for i in trange(0, num_iters, iter_step):
        # Prepare batch
        data_batch = data[i:i + batch_size]
        mol_batch = ReactionDataset(data_batch) if reaction else MoleculeDataset(data_batch)
        ...
        with torch.no_grad():
            if reaction:
                ...
                batch_vecs = model(rbatch, pbatch, features_batch)
            else:
