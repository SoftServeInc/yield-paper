...
SPACE = {
    # 'hidden_size': hp.quniform('hidden_size', low=800, high=800, q=0),
    # 'depth': hp.quniform('depth', low=2, high=6, q=1),
    'depth_diff': hp.quniform('depth_diff', low=0, high=2, q=1),
    # 'dropout': hp.quniform('dropout', low=0.1, high=0.2, q=0.05),
    # 'diff_hidden_size': hp.quniform('depth_diff', low=512, high=512, q=0),

    # 'init_lr': hp.quniform('init_lr', low=0.00005, high=0.001, q=0.0005),
    # 'ffn_num_layers': hp.quniform('ffn_num_layers', low=1, high=3, q=1)
}
# INT_KEYS = ['hidden_size', 'depth', 'depth_diff', 'ffn_num_layers']
INT_KEYS = ['depth_diff' ]
